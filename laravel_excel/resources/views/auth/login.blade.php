        ...
        <div
            ...
            <div class="bg-[#B143F5] rounded-l-[10px] w-full md:px-24 md:py-20 text-white">
                ...
                <div class="mt-12">
                    ...
                    <p class="text-md font-medium">Awesome, we've created the perfect place for you to store all your products</p>
                </div>
                <div class="w-full md:mt-6 flex justify-center items-center">
                   <img class="md:w-[262px] md:h-[262px]" src="{{ Vite::asset('resources/images/1.png') }}" alt="Logo">
                </div>
            </div>
            <form action="" class="w-full h-full rounded-r-[10px] md:py-20 md:px-16 bg-white">
                <header>
                ...
                <button class="w-full bg-[#9333ea] text-white text-lg font-bold py-2 rounded mt-4" type="submit">Login</button>
            </form>
        </div>
    </main>
    <script>
